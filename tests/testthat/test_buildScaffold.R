...
expected_cols <- c("label","DEgenes", "eigenvalues", "rank", "pca")
...
test_that("buildScaffold() returns a proper space",{
    ...
    expect_setequal(names(space2), c(expected_cols, "umap"))
    ...
    expect_setequal(names(space3), expected_cols)
    ...
    expect_setequal(names(space4), expected_cols)
    ...
    expect_setequal(names(space7), c(expected_cols, "umap"))
